        ...
        <div className="bg-white dark:bg-darkMcBlack mb-[165px] sm:mb-[65px]">
            <div className="mx-auto max-w-2xl px-4 sm:px-6 lg:py-20 lg:grid lg:max-w-7xl lg:grid-cols-2 lg:gap-x-8 lg:px-8">
                <div className="lg:max-w-lg lg:self-end">
                    <div className="mt-4">
                        <h1 className="text-3xl font-bold tracking-tight text-gray-900 dark:text-gray-200 sm:text-4xl">{product.name}</h1>
                    </div>
                    <section aria-labelledby="information-heading" className="mt-4">
                        <h2 id="information-heading" className="sr-only">Product information</h2>
                        <div className="flex items-center">
                            <p className="text-lg text-gray-900 dark:text-gray-200 sm:text-xl">{formattedPrice}</p>
                        </div>
                        <div className="mt-4 space-y-6">
                            <p className="text-base text-gray-500 dark:text-gray-200">{product.description}</p>
                        </div>
                    </section>
